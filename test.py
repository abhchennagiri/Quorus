...
# Data Parameters
tf.flags.DEFINE_string("test_data_file", "./datasets/test.full.tsv", "Data source for the test data.")
...
# Load data
print("Loading data...")
q1, q2, y, q1_lengths, q2_lengths = helpers.load_data_and_labels(FLAGS.test_data_file)
x_raw = q1 + q2
...
with graph.as_default():
    ...
    with sess.as_default():
        ...
        batches = helpers.batch_iter(list(zip(x1_test, x2_test, q1_lengths, q2_lengths)), FLAGS.batch_size, shuffle=False)
