...
# Load data
print("Loading data...")
q1, q2, y, x1_lengths, x2_lengths = helpers.load_data_and_labels(FLAGS.training_data_file)
...
#    for j in xrange(len(x1[i])):
#        if x1[i][j] != xx1[i][j]:
#            print "My understanding is not right"
...
with tf.Graph().as_default():
    ...
    with sess.as_default():
        ...
        for epoch in range(FLAGS.num_epochs):
            ...
            # Generate batches
            batches = helpers.batch_iter(dataset, FLAGS.batch_size)
